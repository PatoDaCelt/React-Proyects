    ...
    return (
        <header data-aos='fade-up' className='text-gray-600 body-font z-10'>
            <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
                ...
                <button className='inline-flex items-center py-1 px-7 focus:outline-none text-base font-bold text-white mt-4
                md:mt-0 border border-white hover:bg-yellow-500 hover:border-yellow-500 hover:text-gray-900'>
